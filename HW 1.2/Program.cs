...
class Program
{
	...
	static void SaleTotal()
	{
		...
		Console.WriteLine("Please enter the dicount rate for the item you are purchasing. If there is no discount, enter 0.");
		double discount = double.Parse(Console.ReadLine());

		const double taxrate = 0.085;;

		double subtotal = (itemquantity * itemprice) - discount;
